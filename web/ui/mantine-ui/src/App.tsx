...
import PrometheusLogo from "./images/indradhanus.png";
...
import HostnamesPage from './pages/HostnamesPage';
...
const monitoringStatusPages = [
  ...
  {
    title: "Hostnames State",
    path: "/hostnames",
    icon: <IconDeviceDesktopAnalytics style={navIconStyle} />,
    element: <HostnamesPage />,
    inAgentMode: true,
  },
];
